...
def test_init_default_path(sample_config, mock_config_file):
    with patch('pathlib.Path.home') as mock_home, \
        ...
        assert config_manager.config_path == Path('/home/user/.config/aisignal/config.yaml')
...
def test_load_config(mock_config_file, sample_config):
    ...
    with patch('pathlib.Path.exists') as mock_exists, \
        ...
        assert config_manager.obsidian_vault_path == sample_config['obsidian']['vault_path']
        assert config_manager.obsidian_template_path == sample_config['obsidian']['template_path']
        assert config_manager.content_extraction_prompt == sample_config['prompts']['content_extraction']
